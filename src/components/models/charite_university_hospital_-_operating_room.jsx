...
Command: npx gltfjsx@6.5.3 charite_university_hospital_-_operating_room.glb --draco 
...
export function ChariteUniversityHospitalOperatingRoom(props) {
  const { nodes, materials } = useGLTF(
    "/charite_university_hospital_-_operating_room.glb",
  );
  return (
